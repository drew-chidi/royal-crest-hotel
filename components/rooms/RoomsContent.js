      ...
      <Card>
        <div>
          ...
          <p className={styles.intro}>
            ...
            You&#39;ll enjoy free Wi-Fi, a flat-screen TV, a mini-fridge, and a
            private bathroom with complimentary toiletries. Some of our rooms
            also have a balcony or patio, offering stunning views of the
            surrounding area.
          </p>
        </div>
        <div className={styles.itemBox}>
          ...
          <div className={styles.contentGroup}>
            ...
            <p className={styles.description}>
              ...
              Each room features a comfortable bed, flat-screen TV, mini-fridge,
              and free Wi-Fi. The private bathroom comes equipped with a shower,
              toilet, and complimentary toiletries. Our standard rooms are a
              great choice for those looking for an affordable and comfortable
              place to stay.
            </p>
          </div>
        </div>
